...
## Текущая разработка
[ ] Починить договоры
[ ] Сравнение с прошлым годом по магам, уникам, без психов
[ ] Сравнение в относительных интервалах
...
# Archive
[x] Бюджет и коммерция разделить в заявлениях
[x] Портреты по годам сравнить
[x] Количество регистраций за 1/2 недели
[x] Уники отдельно по магам, отдельно по бакам, отдельно сумма, отдельно сумма без психологий
[x] Сделать поле понедельной выгрузки начиная с разных дат (1 апреля, 20 июня)
